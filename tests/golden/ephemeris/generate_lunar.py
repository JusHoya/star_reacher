...
of the Phase 8 cross-tool preparation deferred through the PRD section 9 valve
(``docs/release_checklist.md``): the DE440 kernels were not fetched on the
Phase 8 execution host, so the excerpt is prepared here and generated by the
maintainer alongside the frozen GMAT truth.
"""

...
date = "{GENERATION_DATE}"
tolerance = "not applicable (input fixture; committed binary excerpt per the Phase 2 exception recorded in tests/golden/README.md). Consumers: missions/leo_drag_hp.toml (its [environment] ephemeris path), tests/python/test_crosstool_missions.py, and the doctest cases env_composition_matches_sum_of_terms and env_error_paths"
'''

...
\subsection{\texorpdfstring{$J_2$}{J2} secular rates (acceptance formulas)}
...
% longtable rather than table: this table has exceeded a page since ae13a64
% created it with all ten rows at once, and a float too large for the page

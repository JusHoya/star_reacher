...
% Derivation slot of the FR-29 six-section template. This chapter derives no
% new physics (that lives in the per-model chapters it composes); what is
% normative and derived here is the composition itself, so the heading names
% the derivation slot explicitly while keeping the descriptive qualifier.
\section{Derivation: composition and plumbing}

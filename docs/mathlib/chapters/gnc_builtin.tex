...
\begin{table}[htbp]
  ...
  \begin{tabular}{lp{7.2cm}}
    ...
    \testid{test_pd_law_python_reimplementation_contract} &
      Exit criterion~2: an independent Python transcription of
      equations~\eqref{eq:gnc:deltaq}--\eqref{eq:gnc:sat} reproduces the
      logged applied torques to
      $< \qty{e-9}{\newton\metre}$ across the whole reference run. \\
...
The following gate remains outstanding:
\begin{itemize}

...
% longtable rather than table: this table has exceeded a page since ab24254
% created it with all seven rows at once, and a float too large for the page
% drops its trailing rows from the PDF while the source still lists them.
\begin{longtable}{lp{3.2cm}p{6.2cm}}
  ...
  \midrule
  \endfirsthead
  \multicolumn{3}{@{}l}{\itshape Table \thetable\ continued from the previous page.} \\
  \toprule
  Test ID & Suite & Acceptance basis \\
  \midrule
  \endhead

// Vendored single-header copy of doctest v2.4.11, unmodified below this
// comment block. Upstream: https://github.com/doctest/doctest, tag v2.4.11,
// file doctest/doctest.h, retrieved 2026-07-02. License: MIT, Copyright (c)
// 2016-2023 Viktor Kirilov (license text stated in the upstream header
// below). Vendored per PRD D-14: a single-header test framework keeps
// compile cost low on Pi-class hardware and adds no fetch step to the build.
